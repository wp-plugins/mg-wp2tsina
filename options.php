...
?>
                <br/>
                <span class="description">在Post详细页，如果该信息已经被同步到新浪微博上，那么显示一个提示信息。</span>
            </td>
        </tr>
        <tr valign="top">
            <th scope="row">显示图标</th>
            <td>
                <label><input type="checkbox" name="mg_wp2tsina[logo]" value="1"<?php echo !empty($this->options['logo']) && $this->options['logo']==1 ? ' checked' : ''; ?> /><img src="<?php echo WP_PLUGIN_URL; ?>/mg-wp2tsina/logo-1.png" border="0" /></label>
                &nbsp;&nbsp;
                <label><input type="checkbox" name="mg_wp2tsina[logo]" value="2"<?php echo !empty($this->options['logo']) && $this->options['logo']==2 ? ' checked' : ''; ?> /><img src="<?php echo WP_PLUGIN_URL; ?>/mg-wp2tsina/logo-2.png" border="0" /></label>
                &nbsp;&nbsp;
                <label><input type="checkbox" name="mg_wp2tsina[logo]" value="3"<?php echo !empty($this->options['logo']) && $this->options['logo']==3 ? ' checked' : ''; ?> /><img src="<?php echo WP_PLUGIN_URL; ?>/mg-wp2tsina/logo-3.png" border="0" /></label>
                &nbsp;&nbsp;
                <label><input type="checkbox" name="mg_wp2tsina[logo]" value="4"<?php echo !empty($this->options['logo']) && $this->options['logo']==4 ? ' checked' : ''; ?> /><img src="<?php echo WP_PLUGIN_URL; ?>/mg-wp2tsina/logo-4.png" border="0" /></label>
                &nbsp;&nbsp;
                <label><input type="checkbox" name="mg_wp2tsina[logo]" value="5"<?php echo !empty($this->options['logo']) && $this->options['logo']==5 ? ' checked' : ''; ?> /><img src="<?php echo WP_PLUGIN_URL; ?>/mg-wp2tsina/logo-5.png" border="0" /></label>
            </td>
        </tr>
    </table>
    ...
    <table class="form-table">
        <tr valign="top">
            <td>
                ...
                <br/>
                <label><input type="checkbox" name="mg_wp2tsina[supportus][tsina]" value="1"<?php echo $this->options['supportus']['tsina']!=-1 ? ' checked' : ''; ?> />加入我们新浪官方微博，获得最新插件更新信息</label>
            </td>
        </tr>
    </table>
